...
train.to_csv(os.path.join(cwd, 'GDELTn', 'train.txt'), index=None, sep='\t', header=None)
valid.to_csv(os.path.join(cwd, 'GDELTn', 'valid.txt'), index=None, sep='\t', header=None)
test.to_csv(os.path.join(cwd, 'GDELTn', 'test.txt'), index=None, sep='\t', header=None)
print('done')